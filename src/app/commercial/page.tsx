  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              We pride ourselves in being the most professional and efficient roofing contractors
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Roof Replacement</h2>
          <p className="text-lg text-gray-700 mb-6 max-w-3xl">
            We take pride in being experienced roofing contractors with knowledge of all Roofing
            Materials. We are happy to research the best system for your project.
          </p>
          <p className="text-lg text-gray-700 mb-6">
            We offer most commercial applications including:
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-3xl">
            {["Shingle Roofing", "Asphalt Roofing", "Metal Roofing", "Rubber Roofing"].map(
              (material) => (
                <div key={material} className="bg-white p-4 rounded-lg text-center shadow-sm">
          ...
          <ul className="space-y-4 max-w-3xl">
            <li className="flex items-start gap-3">
              ...
              <span className="text-gray-300 text-lg">
                We handle all types of roof repairs including metal and emergency repairs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
