...
export const metadata: Metadata = {
  ...
  description:
    "Vertical roof metal carports — the strongest style available. Snow and debris shed easily. Western NC installation by Kings Roofing.",
};
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              The vertical roof is the premium option — roofing panels run ridge to eave so water,
              snow, and debris shed immediately. The most structurally sound carport style and the
              best choice for WNC&apos;s weather.
            </p>
