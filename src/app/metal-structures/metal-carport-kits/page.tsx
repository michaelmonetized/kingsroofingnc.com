...
export const metadata: Metadata = {
  ...
  description:
    "Metal carport kits in Western NC - Regular style, boxed eave, and vertical roof carports. Call Kings Roofing for your free quote.",
};
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 text-white py-20">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Metal Carport Kits</h1>
          <p className="text-xl text-gray-300">Quality metal carports for every need</p>
        </div>
      </section>
          ...
          <div className="space-y-16 max-w-4xl mx-auto">
            {CARPORT_STYLES.map((style) => (
              <div key={style.title} className="border-b border-gray-200 pb-16 last:border-0">
                <h2 className="text-3xl font-bold text-gray-900 mb-2">{style.title}</h2>
                <h3 className="text-xl text-orange-500 font-semibold mb-4">{style.subtitle}</h3>
                <p className="text-lg text-gray-700 mb-6">{style.description}</p>
                <Link
                  href={style.link}
