...
export const metadata: Metadata = {
  ...
  description:
    "Regular style metal carports for car shelters, boat storage, RV carports, and more. Affordable metal carport solutions in Western NC. Free quotes.",
};

const USE_CASES = [
  {
    title: "Vehicle Protection",
    desc: "Single and double carports to protect your car, truck, or SUV from rain, hail, and UV damage.",
  },
  {
    title: "Boat & RV Storage",
    desc: "Wide-span options available for boats, trailers, and full-size RVs year-round.",
  },
  {
    title: "Farm Equipment",
    desc: "Cover tractors, ATVs, and equipment from the elements without the cost of a full building.",
  },
  {
    title: "Combo Units",
    desc: "Pair with enclosed storage bays for a versatile workspace or workshop.",
  },
];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8">
              The most affordable and popular carport style — sturdy A-frame construction with
              horizontal roof panels. Perfect for vehicles, boats, RVs, and equipment storage in
              Western NC.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-900 mb-10">
            What Can a Regular Style Carport Do For You?
          </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <p className="text-gray-600 text-lg mb-4">
            We&apos;ve been installing metal carports across Western North Carolina for over a
            decade. Every structure is professionally installed by our local crew — no
            sub-contractors, no surprises.
          </p>
          <p className="text-gray-600 text-lg">
            All our metal carports are backed by manufacturer warranties and installed to meet North
            Carolina&apos;s wind and snow load codes. Call us for a free, no-pressure quote.
          </p>
        </div>
      </section>
