  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-6">
              ...
              qualified around. Whether your roof just needs a minor repair or needs to be replaced
            ...
            <p className="text-xl text-gray-300 mb-8">
              ...
              contractors put years of experience to work for you at the most reasonable prices
              around. For a Free Estimate, Call us at{" "}
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Roof Replacement</h2>
          <ul className="space-y-4 max-w-3xl">
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-700 text-lg">
                CertainTeed &amp; GAF full-color shingle
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-700 text-lg">
                All types of shingles; 3-tab, asphalt, fiberglass, architectural, premium designer,
                steel, metal, composite, shakes, and genuine slate.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-700 text-lg">
                Learn about EnergyStar tax credits up to $1500 for roofing material.
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl">
            {[
              ...
              <div key={material} className="bg-gray-100 p-4 rounded-lg text-center">
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold mb-2">Roof Repair</h2>
          <h3 className="text-xl text-orange-400 font-semibold mb-8">Residential/Commercial</h3>
          <ul className="space-y-4 max-w-3xl">
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-300 text-lg">
                We handle all types of roof repairs including emergency repairs.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-300 text-lg">
                Roof, chimney, and skylight leaks. Wind, hail, or tree limb damage. Flashing repair.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-300 text-lg">
                Roof drains/pipe boot replacement. Ice dams/water backup.
              </span>
            </li>
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
            ...
            <li className="flex items-start gap-3">
              <span className="text-orange-500 font-bold mt-1">•</span>
              <span className="text-gray-300 text-lg">
                Preventative maintenance. Gutters/siding.
              </span>
            </li>
          </ul>
        </div>
      ...
      <section className="py-20 bg-orange-500">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Contact Us Today!</h2>
          <div className="space-y-4 mb-8">
            ...
            <p className="text-xl text-white">
              <a href="mailto:kingshaywood@gmail.com" className="hover:underline">
                kingshaywood@gmail.com
              </a>
            </p>
          </div>
          <Link
